...
do
  file_path="./"$file
  echo $file_path
  /home/exacloud/lustre1/PARC/darakjia/programs/STAR_2.3.0e/STAR --genomeDir /home/exacloud/lustre1/PARC/darakjia/genomes/MacaM/ --readFilesIn $file_path --readFilesCommand zcat --outFileNamePrefix ${file}_ --runThreadN 12 --outFilterMismatchNmax 3 --outFilterMultimapNmax 1             
